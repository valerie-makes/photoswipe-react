...
import { specialKeyUsed, getElementsFromOption } from '../util/util.js';
...
class PhotoSwipeLightbox extends PhotoSwipeBase {
  ...
  onThumbnailsClick(e) {
    ...
    if (clickedIndex >= 0) {
      e.preventDefault();
      this.loadAndOpen(clickedIndex, dataSource);
    }
  }
  ...
  destroy() {
    if (this.pswp) {
      this.pswp.template.style.visibility = 'hidden';
      this.pswp.close();
    }
